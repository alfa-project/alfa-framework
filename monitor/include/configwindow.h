...
class ConfigWindow : public QDialog {
 ...
 public:
  explicit ConfigWindow(string config_topic, std::shared_ptr<RosInterface> ros_interface,
                        QWidget *parent = nullptr);
  explicit ConfigWindow(string config_topic, string config_tag,
                        vector<alfa_msg::msg::ConfigMessage> defaults, QWidget *parent = nullptr);
  ~ConfigWindow();
