...
BoxSettings::BoxSettings(QWidget *parent) : QDialog(parent),
                                            ui(new Ui::BoxSettings)
{
    ui->setupUi(this);
}
BoxSettings::BoxSettings(QWidget *parent, box *mBox, vector<box> *mListBox) : QDialog(parent),
                                                                              ui(new Ui::BoxSettings)
{
    boxlist = mListBox;
    boxseletecd = mBox;
