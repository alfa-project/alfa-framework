...
# Hierarchical cell: ZCU104
proc create_hier_cell_ZCU104 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_ZCU104() - Empty argument(s)!"}
     return
  }
  ...
  set ps8_0_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.* ps8_0_axi_periph ]
  set_property CONFIG.NUM_MI {1} $ps8_0_axi_periph


  # Create instance: rst_ps8_0_100M, and set properties
  set rst_ps8_0_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.* rst_ps8_0_100M ]
...
\
  ...
  connect_bd_intf_net -intf_net alfa_unit_0_M_AXI [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.NUMBER_OF_DEBUG_POINTS {0} \
    CONFIG.NUMBER_OF_USER_DEFINES {0} \
    CONFIG.OFFSET {0x40000000} \
    CONFIG.REPRESENTATION_TYPE {1} \
  ] $alfa_unit_0


  # Create interface connections
  connect_bd_intf_net -intf_net alfa_unit_0_M_AXI [get_bd_intf_pins ZCU104/S00_AXI] [get_bd_intf_pins alfa_unit_0/M_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ZCU104/M00_AXI] [get_bd_intf_pins alfa_unit_0/S_AXI]

  # Create port connections
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins ZCU104/peripheral_aresetn] [get_bd_pins alfa_unit_0/i_SYSTEM_rst]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ZCU104/pl_clk0] [get_bd_pins alfa_unit_0/i_SYSTEM_clk]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces alfa_unit_0/M_AXI] [get_bd_addr_segs ZCU104/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces alfa_unit_0/M_AXI] [get_bd_addr_segs ZCU104/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces alfa_unit_0/M_AXI] [get_bd_addr_segs ZCU104/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces ZCU104/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs alfa_unit_0/S_AXI/reg0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-171,-163",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst alfa_unit_0 -pg 1 -lvl 1 -x 270 -y 100 -defaultsOSRD
preplace inst ZCU104 -pg 1 -lvl 2 -x 670 -y 90 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 190 NJ 190 830
preplace netloc rst_ps8_0_100M_peripheral_aresetn 1 0 3 30 200 NJ 200 820
preplace netloc ps8_0_axi_periph_M00_AXI 1 0 3 20 10 NJ 10 830
preplace netloc alfa_unit_0_M_AXI 1 1 1 N 90
levelinfo -pg 1 0 270 670 850
pagesize -pg 1 -db -bbox -sgen 0 0 850 210
"
}
