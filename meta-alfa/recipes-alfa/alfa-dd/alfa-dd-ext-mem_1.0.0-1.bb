SUMMARY = "Recipe for build ALFA Extension memory Linux kernel module"
SECTION = "devel"
LICENSE = "Apache-2.0"
FILE_DIR := "${@os.path.dirname(d.getVar('FILE'))}"
ALFA_FRAMEWORK_PATH = "${FILE_DIR}/../../.."
ALFA_DD_PATH = "${ALFA_FRAMEWORK_PATH}/drivers/alfa_ext_mem"
...
SRC_URI = "file://${ALFA_DD_PATH}/alfa_ext_mem.c \
