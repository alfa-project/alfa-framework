...
DESCRIPTION = "ALFA Octree compression Extension"
SECTION = "devel"
LICENSE = "Apache-2.0"
FILE_DIR := "${@os.path.dirname(d.getVar('FILE'))}"
ALFA_FRAMEWORK_PATH = "${FILE_DIR}/../../.."
ALFA_EXT_PATH = "${ALFA_FRAMEWORK_PATH}/extensions/sw"
ALFA_EXT_NAME = "ext_octree_compression_encoder"

ROS_CN = "${ALFA_EXT_NAME}"
ROS_BPN = "ext-octree-compression"

LIC_FILES_CHKSUM = "file://${ALFA_EXT_PATH}/${ROS_CN}/package.xml;beginline=8;endline=8;md5=12c26a18c7f493fdc7e8a93b16b7c04f"
