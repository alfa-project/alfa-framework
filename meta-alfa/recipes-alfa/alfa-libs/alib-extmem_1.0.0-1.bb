...
FILES:${PN} += "/usr/share/alib_extmem/*"

SRC_URI = "file://${ALFA_LIB_PATH}/${ROS_CN}/package.xml \
		   file://${ALFA_LIB_PATH}/${ROS_CN}/CMakeLists.txt \
		   file://${ALFA_LIB_PATH}/${ROS_CN}/include/alib_extmem.hpp \
		   file://${ALFA_LIB_PATH}/${ROS_CN}/src/alib_extmem.cpp \
		   "
