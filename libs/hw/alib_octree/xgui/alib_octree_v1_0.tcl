...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NUMBER_TREES" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SIZE_ID" -parent ${Page_0}
...
proc update_PARAM_VALUE.NUMBER_TREES { PARAM_VALUE.NUMBER_TREES } {
	# Procedure called to update NUMBER_TREES when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUMBER_TREES { PARAM_VALUE.NUMBER_TREES } {
	# Procedure called to validate NUMBER_TREES
	return true
}

proc update_PARAM_VALUE.SIZE_ID { PARAM_VALUE.SIZE_ID } {
	# Procedure called to update SIZE_ID when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SIZE_ID { PARAM_VALUE.SIZE_ID } {
	# Procedure called to validate SIZE_ID
	return true
}
...
proc update_MODELPARAM_VALUE.SIZE_ID { MODELPARAM_VALUE.SIZE_ID PARAM_VALUE.SIZE_ID } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SIZE_ID}] ${MODELPARAM_VALUE.SIZE_ID}
}

proc update_MODELPARAM_VALUE.NUMBER_TREES { MODELPARAM_VALUE.NUMBER_TREES PARAM_VALUE.NUMBER_TREES } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUMBER_TREES}] ${MODELPARAM_VALUE.NUMBER_TREES}
}
